...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button gridBtn,
      @NonNull Button horizontalBtn, @NonNull TextView textView, @NonNull Button verticalBtn) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, gridBtn, horizontalBtn, textView,
          verticalBtn);
    }
